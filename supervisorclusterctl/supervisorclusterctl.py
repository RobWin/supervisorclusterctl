...
def main(argv=None):
    ...
    try:
        ...
        #subparsers.add_parser("reload", help="Restart supervisord")
        ...
        stop_subparser = subparsers.add_parser("start", help="Stop a process by name")
        ...
        remove_subparser = subparsers.add_parser("start", help="Remove a process by name")
